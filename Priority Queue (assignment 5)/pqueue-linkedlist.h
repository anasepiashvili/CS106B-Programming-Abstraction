...
private:
	...
	/* Priority queue is implemented with Linked list */
	struct Cell {
		string value;
		Cell* next;
	};

	/* Head element is lexicographically smallest */
	Cell* head;

	/* Tail element is lexicographically biggest */
	Cell* tail;

	/* Adds element to the list in the middle or at the end */
	void insert(Cell* cell, string value);
