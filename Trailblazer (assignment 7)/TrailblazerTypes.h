...
/* A type representing information about a location in the world, represented as 
 * cost, color and parent location. It will be used for Dijkstra's algorithm and 
 * A* search to keep track of information of each cell in world in grid of same size.
 */ 
struct node {
	double cost;
	Color color;
